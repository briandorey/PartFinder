...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Cookies["PartFinder"] != null && Request.Cookies["PartFinder"] != null)
        {
            FormsAuthentication.RedirectFromLoginPage(Request.Cookies["PartFinder"].Value, true);
        }
        ...
        if (IsPostBack)
        {
            if (ValidateUser(InputEmail.Text, InputPassword.Text))
            {
                ...
                if (rememberMe)
                {
                    Response.Cookies["PartFinder"].Expires = DateTime.Now.AddDays(30);
                }
                else
                {
                    Response.Cookies["PartFinder"].Expires = DateTime.Now.AddDays(-1);
                }
                Response.Cookies["PartFinder"].Value = InputEmail.Text.Trim();
