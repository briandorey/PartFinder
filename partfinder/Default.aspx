...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    <h2 class="font-weight-light">Inventory summary</h2>
     <div class="row mb-3">
        <div class="col-6 col-md-3 ">
            <div class="card mb-4">
                ...
                <div class="card-body text-center h1 font-weight-light text-primary">
                    <p><a href="/parts/default.aspx"><asp:Literal ID="LitPartCount" runat="server"></asp:Literal></a></p>
                    </div>
            </div>
         </div>
         <div class="col-6 col-md-3">
             <div class="card mb-4">
                <div class="card-header text-center">
                    <h4 class="card-title">Total Manufacturers</h4>
                </div>
                <div class="card-body text-center h1 font-weight-light text-primary">
                    <p><a href="/manufacturers/default.aspx"><asp:Literal ID="LitManCount" runat="server"></asp:Literal></a></p>
                    </div>
            </div>
         </div>
         <div class="col-3 ">
             <div class="card mb-4">
                <div class="card-header text-center">
                    <h4 class="card-title">Total Part Attachments</h4>
                </div>
                <div class="card-body text-center h1 font-weight-light text-primary">
                    <p><a href="/admin/files/"><asp:Literal ID="LitAttachmentCount" runat="server"></asp:Literal></a></p>
                    </div>
            </div>
         </div>
         <div class="col-6 col-md-3">
             <div class="card mb-4">
                <div class="card-header text-center">
                    <h4 class="card-title">Total Storage Locations</h4>
                </div>
                <div class="card-body text-center h1 font-weight-light text-primary">
                    <p><a href="/storage/"><asp:Literal ID="LitStorageCount" runat="server"></asp:Literal></a></p>
                    </div>
            </div>
         </div>
         </div>
        ...
        <div class="col-12 ">
            <div class="card mb-4">
                <div class="card-header  d-flex flex-row align-items-center justify-content-between">
                    <h4 class="card-title">Low Stock Parts</h4>
                    <a href="/parts/add.aspx" title="Add new"><i class="fas fa-plus mr-1"></i></a>
                </div>
                <div class="card-body">
                    <!-- start content -->
    ...
    <div class="row mb-3">
        <div class="col-12 "><p class="small">Made with <a href="https://getbootstrap.com/">Bootstrap</a>, <a href="https://github.com/mar10/fancytree">Fancytree</a> and icons from <a href="https://fontawesome.com/">Font Awesome</a>. Developed by <a href="https://www.briandorey.com/">Brian Dorey</a>. Version 1.0.0  March 2020</p></div>
    </div>
