...
<script runat="server">
    protected void Page_Load(Object Src, EventArgs E)
    {
        ...
        {
            string filepath = Request.QueryString["file"].ToString();
            if (System.IO.File.Exists(Server.MapPath(filepath)))
            {
                ...
                using (var bmp = System.Drawing.Image.FromFile(file))
                {
                 
                    sb.Append("<p>Width: " + bmp.Width.ToString() + "px&nbsp;&nbsp;&nbsp;&nbsp;");
                    sb.Append("Height: " + bmp.Height.ToString() + "px</p>");
                }
               
                 sb.Append("<p>Extension: " + fileExtension + "<br>");
                sb.Append("Type: " + MimeTypeMap.GetMimeType(fileExtension) + "</p>");
