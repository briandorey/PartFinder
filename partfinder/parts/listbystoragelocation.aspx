    ...
    protected void Page_Load(Object Src, EventArgs E)
    {
        ...
        if (dv.Count > 0)
        {
            foreach (System.Data.DataRowView drvSql in dv)
            {
                ...
                LitName.Text = drvSql["StorageName"].ToString();
                Page.Title = "Parts in Storage Location " + drvSql["StorageName"].ToString();
            }
        }
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
    <li class="breadcrumb-item active" aria-current="page">Parts by Storage Location</li>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MainConn %>" SelectCommand="SELECT * FROM [View_PartsData] WHERE ([StorageLocationID] = @StorageLocationID) ORDER BY [PartName]">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="0" Name="StorageLocationID" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceFootprint" runat="server" ConnectionString="<%$ ConnectionStrings:MainConn %>" SelectCommand="SELECT * FROM [StorageLocation] WHERE ([StoragePkey] = @StoragePkey)">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="0" Name="StoragePkey" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
